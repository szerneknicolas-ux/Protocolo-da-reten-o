    ...
    <>
      ...
      <section className="hero">
        <div className="container">
          <span className="label !text-[13px]">Protocolo da Retenção Total</span>
          <h1 className="!text-[27px]">Você apaga vídeos porque<br />não sabe <span className="accent">o que falar?</span></h1>
          <p className="sub !text-[18px] !text-[#c7c7c7] !font-sans !leading-relaxed">Pare de <strong className="!text-white !font-semibold">apagar vídeos</strong> e descubra o <strong className="!text-[var(--gold)] !font-semibold">Protocolo da Retenção Total</strong>, o método em 3 passos para transformar qualquer ideia em um vídeo que <strong className="!text-white !font-semibold">prende a atenção do primeiro ao último segundo</strong>.</p>
          <div className="hero-img">
            <img src="/imagens/hero-antes-depois-v2.png" alt="Antes: mulher cansada sem conseguir gravar. Depois: a mesma mulher feliz após gravar seu vídeo." />
        ...
        <div className="container">
          ...
          <div className="proof-grid">
            <div className="proof-col">
              <img src="/imagens/testemunho-antes.jpeg" alt="Perfil antes" />
              <div className="tag tag-antes">Antes</div>
            </div>
            <div className="proof-col">
              <img src="/imagens/testemunho-depois.jpeg" alt="Perfil depois" />
      ...
      <section className="dor">
        <div className="container !max-w-5xl">
          <div className="dor-head">
            <span className="dor-intro !text-[20px] !text-[#fff8f0] !bg-[#960519] !border !border-[#ec3535]">Eu sei... Você não aguenta mais gravar e apagar vídeos</span>
            <h2 className="!text-[21px]">E sofre com <em>pensamentos</em> como...</h2>
          </div>
          <div className="dor-stage">
            <div className="dor-img">
              <img src="/imagens/mulher-cansada.png" alt="Frustração ao gravar" />
            </div>
      ...
      <section className="agita">
        <div className="container">
          <p className="text-[19px] opacity-90">Você não aguenta mais montar roteiros ruins feitos com o ChatGPT que as pessoas pulam nos primeiros segundos.</p>
          <p className="q">Agora eu te pergunto...</p>
          <p className="q !text-[19px]">Se você pudesse ter acesso à estrutura de roteiros que <span className="highlight">convertem seguidores todos os dias</span>, você iria adquirir?</p>
          <p className="text-[14px] opacity-90">Se a resposta for <strong>SIM</strong>, então o Protocolo da Retenção Total é para você.</p>
      ...
      <section className="oferta" id="oferta">
        <div className="container">
          ...
          <img src="/imagens/mockup.png" alt="Mockup Protocolo da Retenção Total" className="offer-mockup" />
          <div className="offer-card">
            ...
            <div className="stack-item main">
              ...
              <span className="price">Incluso</span>
            </div>
            ...
            <div className="total-box">
              <div className="de">De <s>R$372</s> por apenas</div>
      ...
      <section className="about">
        <div className="container">
          <div className="about-card">
            <img src="/imagens/foto-giovanni.png" alt="Gio Seed" className="about-photo" />
      ...
      <footer>
        <div className="footer-cta">
          <img src="/imagens/logo.jpeg" alt="Gio Seed" className="footer-logo" />
        </div>
